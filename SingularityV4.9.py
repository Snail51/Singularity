...
# --- Media ---
NowPlaying = ''
Intro = ''.join([cwd,'\machineintro.wav']) #Duration = 6162
Music = ''.join([cwd,'\machinemusic.wav']) #Duration = 6162
QED = ''.join([cwd,'\Deus_ex_Machina.wav']) #Duration = 2751
